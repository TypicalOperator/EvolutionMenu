...
namespace EvolutionMenu
{
    ...
    public class ExampleClass
    {
        ...
        {
            MenuLogger.Log("Button Pressed, Mod Menu Working.");
        }
        ...
        static void Prefix(GorillaLocomotion.Player __instance)
        {
            ...
            if (init)
            {
                ...
                menu = MenuTemplate.CreateMenu("Evolution Menu V1", new Vector3(0.1f, 1f, 1f), Color.purple, GorillaLocomotion.Player.Instance.leftHandTransform.gameObject);
